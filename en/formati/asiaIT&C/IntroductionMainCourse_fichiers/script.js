...
var g_supportsPPTHTML = SupportsPPTHTML(), g_scaleInFrame = true, gId="", g_bgSound="",
    g_scaleHyperlinks = false, g_allowAdvOnClick = true, g_showInBrowser = true;
...
var ENDSHOW_MESG="Fin du diaporama, cliquez pour quitter.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=20, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   ...
   new hrefList("slide0822.htm", 1, 2),
   new hrefList("slide0823.htm", 1, 3),
   new hrefList("slide0824.htm", 1, 4),
   new hrefList("slide0803.htm", 1, 5),
   new hrefList("slide0644.htm", 1, 6),
   new hrefList("slide0645.htm", 1, 7),
   new hrefList("slide0646.htm", 1, 8),
   new hrefList("slide0647.htm", 1, 9),
   new hrefList("slide0648.htm", 1, 10),
   new hrefList("slide0804.htm", 1, 11),
   new hrefList("slide0805.htm", 1, 12),
   new hrefList("slide0003.htm", 1, 13),
   new hrefList("slide0005.htm", 1, 14),
   new hrefList("slide0004.htm", 1, 15),
   new hrefList("slide0011.htm", 1, 16),
   new hrefList("slide0006.htm", 1, 17),
   new hrefList("slide0321.htm", 1, 18),
   new hrefList("slide0322.htm", 1, 19),
   new hrefList("slide0323.htm", 1, 20)
);
...
var sNext="Suivant",sPrev="Précédent",sEnd="Mettre fin au diaporama",sFont="Arial"
function ShowMenu()
{
	BuildMenu();
