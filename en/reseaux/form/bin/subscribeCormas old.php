...
//Functions
/*--------------------------------------------------------------------------*/
function toGreetingNewMember($im_txtcode,$im_randcode,$emailS,$nomS) {

//	$emailS= $_REQUEST["emailS"];
//	$nomS= $_REQUEST["nomS"];
//	$im_textcode= $_REQUEST["txtcodeS"];
...
<tr>
    ...
    <?  $boncode = toGreetingNewMember($im_txtcode,$im_randcode,$emailS,$nomS);
		if($boncode == true){   //To display the following text (Line no. 79 - 110)if user enters the right image code.?>
